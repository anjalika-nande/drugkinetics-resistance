...
class StochasticSimulation(object):
    ...
    def during_treatment(self, x, eavgs, As, eavgr, Ar, T_input, t_final, number_iterations):
        """
        """
        ...
        x0 = x[0]; ys0 = x[1]; yr0 = 0; vs0 = x[3]; vr0 = 0
        ...
        for num in range(0,number_iterations,1):
            ...
            while t<t_final:
                ...
                birth_ys = self.beta*(1-self.epsilon(eavgs,As,T,t))*(1-self.u)*x_treat[0]*x_treat[3]; death_ys = self.a*x_treat[1]
                birth_yr = self.beta*(1-self.epsilon(eavgs,As,T,t))*self.u*x_treat[0]*x_treat[3]+self.beta*(1-self.epsilon(eavgr,Ar,T,t))*x_treat[0]*x_treat[4]*(1-self.s); death_yr = self.a*x_treat[2]
        ...
        rescue_probability.append(fraction_alive_mutants/number_iterations)
...
result2 = sim.during_treatment(result1,0.9,0.09,0.099,0.09,dose_interval,100,10000)
